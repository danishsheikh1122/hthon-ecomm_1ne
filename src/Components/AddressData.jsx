const statesAndCities = {
    "AndhraPradesh": ["Amaravati", "Guntur", "Kakinada", "Nellore", "Tirupati", "Vijayawada", "Visakhapatnam", "Vizianagaram"],
    ...
    "Karnataka": ["Bengaluru", "Belagavi", "Bellary", "Hubballi", "Kalaburagi", "Mangaluru", "Mysuru", "Shivamogga"],
    "Kerala": ["Alappuzha", "Ernakulam", "Kollam", "Kozhikode", "Thiruvananthapuram", "Thrissur"],
    ...
    "Punjab": ["Amritsar", "Bathinda", "Chandigarh", "Jalandhar", "Ludhiana", "Patiala"],
